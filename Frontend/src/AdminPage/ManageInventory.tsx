      ...
      <main className="flex-grow max-w-7xl mx-auto w-full p-6 space-y-12">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 transition hover:shadow-3xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            ...
            <div className="flex items-center gap-2 border rounded-xl px-4 py-2 focus-within:ring-2 focus-within:ring-green-500 transition">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map((med, i) => (
                  <tr
                    key={i}
                    className="even:bg-gray-50 hover:bg-green-50 hover:scale-[1.01] transition-all duration-300"
                  >
