            ...
            <table className="w-full">
              ...
              <tbody>
                {users.map((user) => (
                  <tr
                    key={user.id}
                    className="border-t hover:bg-gray-50 hover:scale-[1.01] transition-all duration-200"
                  >
                    ...
                    <td className="p-4">
                      <div className="flex justify-center gap-3">
                        <button className="flex items-center gap-1 px-3 py-1.5 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200 hover:shadow-md hover:scale-105 active:scale-95 transition-all duration-200">
                          <Edit size={16} />
                          Edit
                        </button>

                        <button className="flex items-center gap-1 px-3 py-1.5 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 hover:shadow-md hover:scale-105 active:scale-95 transition-all duration-200">
                          <Trash2 size={16} />
                          Delete
                        </button>
                      </div>
